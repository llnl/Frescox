...
%
\title{\Huge Frescox}
\date{Version FRESCOX-7.3, July 2025\\ LLNL-CODE-811517 }
\author{I.J. Thompson
%
...
read FROM FILE `INFILE'  the following lines
   (until a blank line):
\begin{verbatim}
Format 16.2: I4, 3F8.4,          5I4,               2I4,   4A8
             NP, HNP,RFS,FSCALE, TYPE,k,TAU,DER,IT, IB,IA, COMMENT
...
% Then free format for the radial shapes, repeatedly until sufficient data is read.\\
 ...
 If IP1 = 0, read local form factor from i=1 to NP.
